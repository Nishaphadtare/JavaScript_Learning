...
console.log("1.-----------------------------1. Reverse the array -----------------------------");
console.log(`Original array:${array_roll_numbers}`);
array_roll_numbers.reverse();
console.log(`Reverse of array:${array_roll_numbers}`);

console.log("2.-----------------------------2. Use the sort() method as it is without any custom sorting logic (Without passing any arguments) & notice the issue-----------------------------");
...
console.log("3.-----------------------------3. Sort the array in ascending order-----------------------------");
array_roll_numbers.sort((a,b)=>{return a > b ? 1 : -1

});
console.log(`Array sort in ascending order:${array_roll_numbers}`);

console.log("4.-----------------------------4. Sort the array in descending order without using reverse() method only use sort()-----------------------------");
array_roll_numbers.sort((a,b)=>{return a>b?-1:1
});
console.log(`Array sort in descending order:${array_roll_numbers}`);

console.log("5.-----------------------------5 Sort the array in descending order with using reverse() method [ Hint → sort array first using sort()]-----------------------------");
array_roll_numbers.sort((a,b)=>{return a > b ? 1 : -1
